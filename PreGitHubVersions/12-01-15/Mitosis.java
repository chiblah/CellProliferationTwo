...
public class Mitosis
{
	...
	public static void main(String [ ] args)
	{
		try
		{
            ...
            runMitosisSimulation(SIM_DURATION, TIME_INTERVAL, cell_population, 2);
		...
		catch (ArrayIndexOutOfBoundsException|NumberFormatException error)
		{
			...
			printString("Oops! Something is wrong with the input values you entered. Check that you have provided the correct number, and types of input values. Error message => " + error.getMessage());
		}// try-catch
